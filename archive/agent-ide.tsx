/*
 * ZVELCLAW LEGACY VERCEL/EVE WORKSPACE UI ARCHIVE
 *
 * Recovered from the original Vercel/eve scaffold commit:
 * cec5211ba963dd8e049aa70596b9040a5d5cf178
 *
 * Original UI component:
 * app/_components/agent-chat.tsx
 * Original blob:
 * 9358981dbc2f07588c975193aff7ab0128532111
 *
 * Related source files in the original workspace:
 * - app/_components/agent-message.tsx
 * - app/_components/authenticated-agent-chat.tsx
 * - app/_components/web-chat-auth.tsx
 * - app/s/page.tsx
 ...
 * - components/ai-elements/question.tsx
 ...
 * - lib/utils.ts
 *
 * This file is an archive only. It is intentionally not wired into the
 * current application entrypoint yet.
 */

export const LEGACY_VERCEL_EVE_AGENT_CHAT_SOURCE = String.raw`"use client";
